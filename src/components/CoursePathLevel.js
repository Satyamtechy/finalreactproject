...
<div class="page-content-inner">
    ...
    <div class="mt-lg-4" uk-grid>
        <div class="uk-width-1-4@m">
            <img src="assets/images/course/p-1.png" alt="" class="rounded shadow" />
        </div>
        ...
        <div class="uk-width-1-4@m">
            <h5> Related tags </h5>
            <div uk-margin>
                <NavLink to ="#" activeclass="mr-1">Web Developments</NavLink>
                <NavLink to ="#" activeclass="mr-1">Angular</NavLink>
                <NavLink to ="#" activeclass="mr-1">React</NavLink>
                <NavLink to ="#" activeclass="mr-1">Swift</NavLink>
            </div>
        </div>
    ...
    <ul class="course-path-level" uk-accordion>
        ...
        <li class="uk-open">
            <NavLink to ="#" activeclass ="uk-accordion-title">Beginner Level </NavLink>
                            ...
                            <li>
                                <div class="course-card completed">
                                    <div class="course-card-thumbnail">
                                        ...
                                        <NavLink to = "/takecouse" activeclass="play-button-trigger show"> </NavLink>
        ...
        <li class="uk-open">
            <NavLink to ="#" activeclass ="uk-accordion-title"> Intermediate Level </NavLink>
            <div class="uk-accordion-content">
                <p> Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
                    tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam
                    quis nostrud exerci tation ullamcorper suscipit,</p>
...
export default CoursePathLevel

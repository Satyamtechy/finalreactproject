         ...
         <div class="page-content-inner uk-light">
             ...
             <nav class="responsive-tab  style-4" >
                 <ul data-submenu-title="Elements"
                     ...
                     <li><NavLink to="#">Flex</NavLink></li>
                     <li><NavLink to="#">Form</NavLink></li>
                     <li><NavLink to="#">Grid</NavLink></li>
                     <li><NavLink to="#">Heading</NavLink></li>
                     <li><NavLink to="#">icons</NavLink></li>
                     <li><NavLink to="#">List</NavLink></li>
                     <li><NavLink to="#">Pagination</NavLink></li>
                     <li><NavLink to="#">Position</NavLink></li>
                     <li><NavLink to="#">Table</NavLink></li>
                     <li><NavLink to="#">Tab</NavLink></li>
                     ...
                     <div class="uk-width-3-4@s">
                         ...
                         <div class="uk-card uk-card-default uk-card-body uk-width-1-2@m">
                             <h4 class="uk-card-title">Default</h4>
                                 <p>Lorem ipsum <NavLink to="#">dolor</NavLink> sit amet, consectetur adipiscing elit, sed
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                         ...
                         <div class="uk-card uk-card-default uk-width-1-2@m  uk-card-small">
                             ...
                             <div class="uk-card-footer">
                                 <NavLink to="#" activeClassName="uk-uk-button uk-button-text">Read more</NavLink>
                             </div>
                         </div>
                         ...
                         <div class="uk-child-width-1-2@m" uk-grid>
                             <div>
                                 <div class="uk-card uk-card-default">
                                     ...
                                     <div class="uk-card-body">
                                         <h4 class="uk-card-title">Media Top</h4>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                         ...
                         <p> The Flex component can be combined with a grid from the <NavLink to ="/elements-grid">Grid
                                 component</NavLink>. </p>
                         <h6> PREVIEW </h6>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">form</span>&gt;</span></code></pre>
                         ...
                         <div class="uk-width-1-3@m">
                             <form>
                                 ...
                                 <div class="uk-margin">
                                     <div class="uk-inline">
                                         <NavLink to ="#" activeClassName="uk-form-icon" ><i class="far fa-lock"></i></NavLink>
                                 ...
                                 <div class="uk-margin">
                                     <div class="uk-inline">
                                         <NavLink activeClassName="uk-form-icon uk-form-icon-flip"><i
                                                 class="far fa-lock"></i></NavLink>
                                         <input class="uk-input" type="Password" placeholder="Password" />
                                     </div>
                                 </div>
...
<span class="hljs-tag">&lt;<span class="hljs-name">i</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"icon-feather-folder icon-xxlarge"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">i</span>&gt;</span></code></pre>
                         ...
                         <h4 id="Button-with-icon" aria-hidden="false">Button with icon </h4>
                             ...
                             <h4 id="animation">Button with icon animation </h4>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre>
                         ...
                         <p> The pagination component utilizes flexbox, so navigations can easily be aligned with
                             the <NavLink to ="/flex"> Flex component</NavLink> .</p>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre>
                         ...
                         <ul class="uk-pagination">
                             <li><NavLink to="#"><span class="uk-margin-small-right" uk-pagination-previous></span>
                                     Previous</NavLink></li>
                             <li class="uk-margin-auto-left"><NavLink to="#">Next <span class="uk-margin-small-left"
                                         uk-pagination-next></span></NavLink></li>
                         </ul>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                         ...
                         <p>There are two classes to center elements outside on the left and right of the parent
                             container.
                             This is useful to
                             position the Slidenav component outside of an <NavLink to="/slideshow">Slideshow</NavLink>
                             or <NavLink to="/slider">Slider</NavLink> component.</p>
             ...
             <li>
                 ...
                 <div class="mt-4 uk-grid-large" uk-grid>
                     ...
                     <div class="uk-width-3-4@s">
                         ...
                         <ul uk-tab>
                             <li class="uk-active"><NavLink to="#">Left</NavLink></li>
                             <li><NavLink to="#">Item</NavLink></li>
                             <li><NavLink to="#">Item</NavLink></li>
                             <li class="uk-disabled"><NavLink>Disabled</NavLink></li>
                         </ul>
                             ...
                             <div class="uk-child-width-1-2@s" uk-grid>
                                 ...
                                 <div>
                                     <ul class="uk-tab-right" uk-tab>
                                         <li class="uk-active"><NavLink to="#">Right</NavLink></li>
                                         <li><NavLink to="#">Item</NavLink></li>
                                         <li><NavLink to="#">Item</NavLink></li>
                                     </ul>
                                 </div>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                         ...
                         <p> You can combine tabs with the <NavLink to ="/flex">Flex
                                 component</NavLink> or the <NavLink to="/grid">Width component</NavLink> to modify the
                             alignment
                             of the navigations. </p>

                         <div class="uk-margin-medium-top">
                             <ul class="uk-flex-center" uk-tab>
                                 <li class="uk-active"><NavLink to="#">Center</NavLink></li>
                                 <li><NavLink to="#">Item</NavLink></li>
                                 <li><NavLink to="#">Item</NavLink></li>
                             </ul>
                         </div>
                         ...
                         <div class="uk-margin-medium-top">
                             ...
                             <ul class="uk-child-width-expand" uk-tab>
                                 <li class="uk-active"><NavLink to="#">Justify</NavLink></li>
                                 <li><NavLink to="#">Item</NavLink></li>
                                 <li><NavLink to="#">Item</NavLink></li>
                                 <li><NavLink to="#">Item</NavLink></li>
                             </ul>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre>
                         ...
                         <ul uk-tab>
                             ...
                             <li><NavLink to="#">Item</NavLink></li>
                             <li>
                                 <NavLink to="#" class="dropdown-arrow">More <span class="uk-margin-small-left"
                                         uk-icon="icon: triangle-down"></span></NavLink>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre>
                         ...
                         <p> <code>.uk-light</code> to change your tabs to light and <NavLink to="/colors">
                                 background
                                 compunents </NavLink> </p>
                         ...
                         <div class="uk-light bg-grey">
                             <ul class="uk-tab uk-light"
                                 ...
                                 <li class="uk-active"><NavLink to="#">Code Quality</NavLink></li>
                                 <li><NavLink to="#">Code convention</NavLink></li>
                                 <li><NavLink to="#">Code Quality</NavLink></li>
                             </ul>
                         ...
                         <p> Tabs can be used to trigger a dropdown menu from the <NavLink to="/dropdown">Dropdown
                                 component</NavLink></p>
                         ...
                         <div class="bg-grey uk-light uk-padding pb-0 rounded shadow">
                             ...
                             <ul class="uk-tab"
                                 ...
                                 <li class="uk-active"><NavLink to="#"> <i
                                             class="icon-feather-home mr-2"></i>Home</NavLink>
                                 </li>
                                 <li><NavLink to="#"> <i class="icon-feather-message-square mr-2"></i> convention</NavLink>
                                 </li>
                                 <li><NavLink to="#"> <i class="icon-feather-settings mr-2"></i> settings</NavLink></li>
                             </ul>
                         </div>
                         ...
                         <div uk-grid>
                             <div class="uk-width-1-3@m">
                                 <ul class="uk-tab-right shadow p-3 pl-0"
                                     ...
                                     <li><NavLink to="#"> <i class="icon-feather-message-square mr-2"></i>
                                             convention</NavLink></li>
                                     <li><NavLink to="#"> <i class="icon-feather-settings mr-2"></i> settings</NavLink>
                                     </li>
                                 </ul>
                             </div>
                             <div class="uk-width-expand@m">

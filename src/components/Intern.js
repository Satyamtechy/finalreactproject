...
const Intern = () => {
    useEffect(() =>{
        ...
        function apply() {
            var details={
                ...
                linkedin:document.getElementById("LinkedIn_Profile").value,
    ...
    <div class="apply_form">
        <span>Apply for this Intern</span>
        <div id="apply">
            <form>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="LinkedIn_Profile" aria-describedby="emailHelp" />
